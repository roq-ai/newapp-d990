  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to NewApp - Streamlining your workflow with efficient and reliable document management, for a smarter and more organized workspace."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to NewApp - Streamlining your workflow with efficient and reliable document management, for a smarter and more organized workspace.`}
            </Text>
            <Box
